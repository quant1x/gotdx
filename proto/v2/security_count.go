...
// todo: 检测market是否为合法值
func NewSecurityCountRequest(market Market) (*SecurityCountRequest, error) {
...
func NewSecurityCount(market Market) (*SecurityCountRequest, *SecurityCountResponse, error) {
