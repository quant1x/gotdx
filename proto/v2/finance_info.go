...
// todo: 检测market是否为合法值
func NewFinanceInfoRequest(market Market, code string) (*FinanceInfoRequest, error) {
...
func NewFinanceInfo(market Market, code string) (*FinanceInfoRequest, *FinanceInfoResponse, error) {
